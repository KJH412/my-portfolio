  ...
  return (
    <div className="w-full h-screen bg-darkBg">
      ...
      <div className="flex flex-col justify-center items-center mt-14">
          ...
          />
          <div className="text-l bg-white text-gray-800
           w-full max-w-[1200px] min-w-[200px]
           mt-8 px-10 py-10 rounded-xl
           bg-[url('@/assets/images/paper.jpg')] bg-cover bg-center
          ">
            <p className="break-words overflow-wrap">
               인테리어를 전공하며 공간을 설계하던 저는 웹 화면 속에서 
               사용자 경험을 중심으로 더 나은 인터페이스를 만들고자
               웹 퍼블리싱을 학원을 다니며 HTML, CSS, JavaScript를 학습했습니다. 
            </p>
            <p className="break-words overflow-wrap">
               평소 익숙하게 보던 웹 페이지를 직접 만들 수 있다는 사실이 새롭게 다가왔고 직접 기획한 웹 페이지를 구현해보면서 
               사용자와 더 활발히 상호작용하는 웹을 만들고 싶어
            ...
            <p className="break-words overflow-wrap">
               현재는 React를 중심으로 UI/UX를 설계하고 
               작은 부분에서도 사용자 경험 개선을 신경쓰는 프론트엔드 개발자가 되기 위해 노력하고 있습니다.
            </p>
          </div>
      </div>
    </div>
